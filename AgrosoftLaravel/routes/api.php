...
Route::prefix('plaga')->middleware('jwt.verify')->group(function () {
    Route::get('/', [PlagasController::class, 'index']);
    Route::post('/', [PlagasController::class, 'store']);
    Route::put('/{id}', [PlagasController::class, 'update']);
